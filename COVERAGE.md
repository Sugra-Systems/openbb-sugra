...
One Sugra API key fulfils 85 OpenBB standard data models across 13 command groups. Install one provider, set one credential, and pull all of the below - instead of wiring many separate provider keys.
...
| famafrench (4) | Fama-French academic factor returns | obb.famafrench.breakpoints, obb.famafrench.factors, obb.famafrench.regional_portfolio_returns, obb.famafrench.us_portfolio_returns |
...
| fixedincome (5) | Rates and fixed income | obb.fixedincome.government.treasury_auctions, obb.fixedincome.government.yield_curve, obb.fixedincome.rate.effr, obb.fixedincome.rate.sofr, obb.fixedincome.rate.sonia |
