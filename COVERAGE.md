...
One Sugra API key fulfils 89 OpenBB standard data models across 13 command groups. Install one provider, set one credential, and pull all of the below - instead of wiring many separate provider keys.
...
| uscongress (4) | US Congress bills and amendments | obb.uscongress.amendment_info, obb.uscongress.amendments, obb.uscongress.bill_info, obb.uscongress.bills |
