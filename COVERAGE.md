...
One Sugra API key fulfils 88 OpenBB standard data models across 13 command groups. Install one provider, set one credential, and pull all of the below - instead of wiring many separate provider keys.
...
| uscongress (3) | US Congress bills and amendments | obb.uscongress.amendments, obb.uscongress.bill_info, obb.uscongress.bills |
