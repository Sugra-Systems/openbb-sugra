...
PARAMS: dict[str, dict] = {
    ...
    "CikMap": {"symbol": "AAPL"},
    "SymbolMap": {"query": "0000320193"},
    "InstitutionsSearch": {"query": "blackrock"},
    "SicSearch": {"query": "bank"},
    "BalanceSheetGrowth": {"symbol": "AAPL"},
    "CashFlowStatementGrowth": {"symbol": "AAPL", "period": "annual"},
    "IncomeStatementGrowth": {"symbol": "AAPL"},
    "HistoricalAttributes": {"symbol": "AAPL", "tag": "Assets"},
    "LatestAttributes": {"symbol": "AAPL", "tag": "Revenues"},
    "ManagementDiscussionAnalysis": {"symbol": "AAPL"},
    "CompareCompanyFacts": {},
    ...
    "CountryProfile": {"country": "united_states"},
    "EconomicIndicators": {"symbol": "GDP", "country": "united_states"},
    "DirectionOfTrade": {
